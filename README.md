...
- Fixed incompatbility of feature concepts from all 3 inspired theme components. (So this means all the core concepts are still there from all 3)
- Added support for all core styles of Tags; Simple, Bullet, and Box.
- Added contrasting support for label text
